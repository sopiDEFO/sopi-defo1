...
const exp = [
  ...
  // },
  {
    title: "devellopement de sopiIA",
    cardImage: "assets/images/experience-page/IdIT_Bombay.jpg",
    place: "sopi IA",
    time: "(Jan - en cours)",
    desp: "<li>je devellope ma propre ia.</li><li>pour toute participation veuillez me conctacter via le site.</li>",
  },
];
